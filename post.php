...
<article class="post-content shadow mx-3 mt-3 mb-5 p-5 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-900 rounded-lg overflow-hidden">
<div id="post">
...
<div class="mx-3 my-5 shadow rounded-lg overflow-hidden">
<?php $this->options->ad(); ?>
</div>
