...
if (type == "hostimage") {
                    html += `
                    <li class="OwO-item" data-id="${opackage[i].data}" title="${opackage[i].text}"><img class="biaoqing" src="${sitedata.theme_url+opackage[i].icon}"></li>`;
}
else{
if (type == "image") {
                    html += `
                    <li class="OwO-item" data-id=":(${opackage[i].text})" title="${opackage[i].text}"><img class="biaoqing" src="${sitedata.ajax_url+'sinnerimages/biaoqing/'+opackage[i].icon}"></li>`;
}
else{
                    html += `
